...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'hw.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'hw.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'hw.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "hw.html.mem" : null;
