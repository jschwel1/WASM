...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fibo.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fibo.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fibo.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fibo.js.mem" : null;
...
var real__fibo = asm["_fibo"]; asm["_fibo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__fibo.apply(null, arguments);
};
...
var _fibo = Module["_fibo"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fibo"].apply(null, arguments) };
